...
class Solver:
    ...
    def read_file(filename, decisions):
        ...
        return clauses, res_map, literals, cnt
    ...
    def conflict_analyze(self, conf_cls, respf):
        ...
        while True:
            ...
            old_pool_lits = set()            
            old_pool_lits.update(curr_level_lits)
            old_pool_lits.update(prev_level_lits)
            ...
            self.Gcnt +=1
            final_lits = set()
            final_lits.update(curr_level_lits)
